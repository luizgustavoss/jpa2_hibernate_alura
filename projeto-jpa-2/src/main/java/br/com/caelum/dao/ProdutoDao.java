...
public class ProdutoDao {
	...
	public List<Produto> getProdutos(String nome, Integer categoriaId, Integer lojaId) {
		...
		typedQuery.setHint("org.hibernate.cacheable", "true"); // habilita o cache de segundo nível para a query
	...
	/**
	 * Implementação alternativa da consulta, utilizando a API de Criteria do Hibernate
	 * 
	 * @param nome
	 * @param categoriaId
	 * @param lojaId
	...
	@Transactional
	public List<Produto> getProdutosCriteria(String nome, Integer categoriaId, Integer lojaId) {
