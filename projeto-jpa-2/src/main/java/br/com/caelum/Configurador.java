...
public class Configurador extends WebMvcConfigurerAdapter {
	...
	/**
	 * Interceptor responsável por implementar o padrão OpenEntityManagerInView
	 * @return
	 */
	@Bean
	...
	/**
	 * Método responsável por configurar interceptors. Neste caso está configurando o
	 * interceptor responsável pelo padrão OpenEntityManagerInView
	 */
	@Override
